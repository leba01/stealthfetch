...
class TestFetchResultPipeline:
    ...
    def test_sync_result_with_content_and_metadata(self, mock_fetch: AsyncMock) -> None:
    ...
    async def test_async_result_with_content_and_metadata(self, mock_fetch: AsyncMock) -> None:
...
class TestFetchMarkdownPipeline:
    @patch("stealthfetch._core._afetch_http", new_callable=_make_afetch_ok)
    def test_sync_fetch(self, mock_fetch: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    @patch("stealthfetch._core._afetch_http", new_callable=AsyncMock)
    async def test_async_fetch(self, mock_fetch: AsyncMock) -> None:
        mock_fetch.return_value = (_ARTICLE_HTML, 200, "text/html")
...
class TestRetry:
    ...
    @patch("stealthfetch._core._afetch_http", new_callable=AsyncMock)
    def test_retries_on_transient_5xx(self, mock_fetch: AsyncMock, mock_sleep: AsyncMock) -> None:
    ...
    @patch("stealthfetch._core.asyncio.sleep", new_callable=AsyncMock)
    @patch("stealthfetch._core._afetch_http", new_callable=AsyncMock)
    def test_no_retry_on_4xx(self, mock_fetch: AsyncMock, mock_sleep: AsyncMock) -> None:
    ...
    @patch("stealthfetch._core.asyncio.sleep", new_callable=AsyncMock)
    @patch("stealthfetch._core._afetch_http", new_callable=AsyncMock)
    def test_exhausted_retries_raises(self, mock_fetch: AsyncMock, mock_sleep: AsyncMock) -> None:
    ...
    @patch("stealthfetch._core.asyncio.sleep", new_callable=AsyncMock)
    @patch("stealthfetch._core._afetch_http", new_callable=AsyncMock)
    async def test_async_retry(self, mock_fetch: AsyncMock, mock_sleep: AsyncMock) -> None:
